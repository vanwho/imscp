...
function _admin_generatePhpBlock($tpl, $phpini)
{
	...
	$tplVars['TR_CAN_EDIT_ALLOW_URL_FOPEN'] = tr('Can edit the PHP %s directive', '<b>allow_url_fopen</strong>');
	...
	if (PHP_SAPI == 'apache2handler') {
		...
		$tplVars['TR_CAN_EDIT_DISABLE_FUNCTIONS'] = tr('Can edit the PHP %s directive', '<strongb>disable_functions</strong>');
...
if (isset($cfg->HOSTING_PLANS_LEVEL) && $cfg->HOSTING_PLANS_LEVEL == 'admin') {
	...
	$tpl->define_dynamic(
		array(
			...
			'page' => 'shared/partials/forms/hosting_plan_edit.phtml',
			'page_message' => 'layout',
