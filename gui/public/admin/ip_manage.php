...
$tpl->assign(
	array(
		...
		'TR_MESSAGE_DELETE' => tr("Are you sure you want to delete the %s IP address?", '%s'),
		'TR_MESSAGE_DENY_DELETE' => tr('You cannot remove the %s IP address.', '%s'),
