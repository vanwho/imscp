...
$tpl->define_dynamic(
	array(
		...
		'page' => 'admin/software_rights.phtml',
		'page_message' => 'layout',
		'list_reseller' => 'page',
...
$tpl->assign(
	array(
		...
		'TR_SOFTWARE_NAME' => tr('%s - (Version: %s, Language: %s)', $rs->fields['software_name'], $rs->fields['software_version'], $rs->fields['software_language']),
