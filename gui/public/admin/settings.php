...
$tpl->assign(
	array(
		...
		'TR_PHPINI_ALLOW_URL_FOPEN' => tr('Value for the %s directive', '<strong>allow_url_fopen</strong>'),
		'TR_PHPINI_DISPLAY_ERRORS' => tr('Value for the %s directive', '<strong>display_errors</strong>'),
		'TR_PHPINI_ERROR_REPORTING' => tr('Value for the %s directive', '<strong>error_reporting</strong>'),
		...
		'TR_PHPINI_POST_MAX_SIZE' => tr('Value for the %s directive', '<strong>post_max_size</strong>'),
		'TR_PHPINI_UPLOAD_MAX_FILESIZE' => tr('Value for the %s directive', '<strong>upload_max_filesize</strong>'),
		'TR_PHPINI_MAX_EXECUTION_TIME' => tr('Value for the %s directive', '<strong>max_execution_time</strong>'),
		'TR_PHPINI_MAX_INPUT_TIME' => tr('Value for the %s directive', '<strong>max_input_time</strong>'),
		'TR_PHPINI_MEMORY_LIMIT' => tr('Value for the %s directive', '<strong>memory_limit</strong>'),
		'TR_PHPINI_OPEN_BASEDIR' => tr('Value for the %s directive', '<strong>open_basedir</strong>'),
		'TR_PHPINI_OPEN_BASEDIR_TOOLTIP' => tr('Paths are appended to the default PHP open_basedir directive of customers. Each of them must be separated by PATH_SEPARATOR. See the PHP documentation for more information.'),
		'TR_PHPINI_DISABLE_FUNCTIONS' => tr('Value for the %s directive', '<strong>disable_functions</strong>'),
		'TR_MIB' => tr('MiB'),
		'TR_SEC' => tr('Sec.')
	)
);
